...
relates_to: [SPEC-039, DR-071, DR-050, DR-051, DR-060, DR-061, DR-012]
...
- **OQ-1 → zero-click approvals, delivered WITHOUT changing the contributed default (new FR-8).**
  ...
  **Why a prompt at all, rather than shipping it on.** The founder's stated reason for
  ...
  proposing it as a principle is tracked separately so this spec does not smuggle a
  constitution change through a Clarify.
