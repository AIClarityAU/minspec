...
- **Open team work (members — labelled `epic:team-readiness`):**
  - [#95](https://github.com/harvest316/minspec/issues/95) — team-readiness: shared,
  ...
  - [#207](https://github.com/harvest316/minspec/issues/207) — reviewer-authority
...
- [#3](https://github.com/harvest316/minspec/issues/3) — CI-based agent dispatch
  for teams (shared GitHub Actions runners; the team mode of agent dispatch).
- [#251](https://github.com/harvest316/minspec/issues/251) — team-safe auto-drain
  (a shared inbox must not fan out across teammates — one designated drainer,
  atomic claim/dedup).
- [#267](https://github.com/harvest316/minspec/issues/267) — collision-proof
  DR/SPEC IDs minted at merge (the multi-clone residual that #176's same-machine
  fix cannot reach).

> Excluded after review: DR-033 / [#211](https://github.com/harvest316/minspec/issues/211)
