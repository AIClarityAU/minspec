...
# against it.
#
# Coverage: specs/** · docs/** · skills/**/*.md (markdown ONLY — a bare skills/
# arm would admit skills/foo/run.sh onto an auto-merge lane) · .minspec/approvals/**
# · top-level *.md.
...
DOCS_CORPUS_RE='^(specs/|docs/|skills/.*\.md$|\.minspec/approvals/|[^/]+\.md$)'
