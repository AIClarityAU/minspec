...
import type { SpecStatus } from '../lib/spec';
...
export const STATUS_GROUPS: StatusGroup[] = [
  ...
  // `planning` (DR-069 / #886): approved, but the implement phase has not started —
...
function statusIcon(status: SpecStatus): string {
  switch (status) {
    ...
    case 'planning': return 'checklist'; // DR-069: approved, pre-implement
