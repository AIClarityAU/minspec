/**
 * T0/T3 — DR-077: the verdict is a VALUE the reviewer returns, not TEXT it types.
 *
...
describe('DR-077 renderVerdictBlock — the parent writes the block', () => {
...
describe('DR-077 parseCliVerdict — only the schema channel is trusted', () => {
...
describe('DR-077 review-branch.sh — wiring, not just intent', () => {
